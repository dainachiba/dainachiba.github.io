...
See: https://github.com/francoischalifour/medium-zoom`);
      ...
      var i2, o2 = n({ bubbles: false, cancelable: false, detail: 0[0] }, s2);
      ...
      var r2, u2, O2 = arguments.length > 1 && arguments[1] !== 0[0] ? arguments[1] : {}, p2 = window.Promise || function(t3) {
        function n2() {
        }
        t3(n2, n2);
      }, S2 = function(t3) {
        ...
        var l3, t3 = arguments.length > 0 && arguments[0] !== 0[0] ? arguments[0] : {}, o3 = t3;
        ...
        var t3 = arguments.length > 0 && arguments[0] !== 0[0] ? arguments[0] : {};
        return w(n({}, i2, t3));
      }, v2 = function() {
        ...
        var s2 = arguments.length > 2 && arguments[2] !== 0[0] ? arguments[2] : {};
        ...
        var f3 = arguments.length > 0 && arguments[0] !== 0[0] ? arguments[0] : {}, t3 = f3.target, h3 = function() {
          if (t4 = { width: document.documentElement.clientWidth, height: document.documentElement.clientHeight, left: 0, top: 0, right: 0, bottom: 0 }, s2 = 0[0], r3 = 0[0], i2.container) if (i2.container instanceof Object) t4 = n({}, t4, i2.container), s2 = t4.width - t4.left - t4.right - i2.margin * 2, r3 = t4.height - t4.top - t4.bottom - i2.margin * 2;
          else {
        ...
        var t3 = arguments.length > 0 && arguments[0] !== 0[0] ? arguments[0] : {}, n2 = t3.target;
        ...
        return o2.original;
      }, c2 = [], h2 = [], d2 = false, m2 = 0, i2 = O2, o2 = { original: null, zoomed: null, zoomedHd: null, template: null };
      return Object.prototype.toString.call(t2) === "[object Object]" ? i2 = t2 : (t2 || typeof t2 == "string") && v2(t2), i2 = n({ margin: 0, background: "#fff", scrollOffset: 40, container: null, template: null }, i2), u2 = V(i2.background), document.addEventListener("click", S2), document.addEventListener("keyup", k2), document.addEventListener("scroll", A2), window.addEventListener("resize", l2), r2 = { open: g2, close: l2, toggle: f2, update: C2, clone: b2, attach: v2, detach: E2, on: _2, off: F2, getOptions: j2, getImages: y2, getZoomedImage: x2 }, r2;
    };
    function N(e2, t2) {
      t2 === 0[0] && (t2 = {});
